...
% Newton's method converges faster than Broyden's method, requiring 
% fewer iterations to reach the desired solution. Although Broyden's
% method is superlinear, Newton's method has a quadratic convergence
% rate, making it faster.